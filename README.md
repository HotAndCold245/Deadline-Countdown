...
# SideBar View
The deadlines can be viewed from the sidebar where they are arranged in the same order as they appear in the management section of the settings menu. There is a refresh button at the top to manually update the list after adding or removing deadlines. 
